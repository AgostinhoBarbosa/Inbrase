...
INSERT INTO system_program
VALUES ((select coalesce(max(id), 0) + 1 from system_program b), 'Ajuda', 'AjudaView');
INSERT INTO system_group_program
VALUES ((select coalesce(max(id), 0) + 1 from system_group_program b), 1,
        (select id from system_program where controller = 'AjudaView'));
