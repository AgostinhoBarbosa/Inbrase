<?php
    ...
    class SystemSQLPanel extends TPage
    {
        ...
        public function __construct()
        {
            ...
            $this->form->addFields( [$ld = new TLabel( _t( 'Database' ) ), $database], [$lt = new TLabel( _t( 'Table' ) ), $table] )->layout = ['col-md-3', 'col-md-6'];
            $this->form->addFields( [$ls = new TLabel( 'SELECT' ), $select] )->layout = ['col-md-9'];

            $this->form->addAction( _t( 'Generate' ), new TAction( [$this, 'onGenerate'] ), 'fa:check-circle blue fa-lg' );
            $this->form->addAction( 'CSV', new TAction( [$this, 'onExportCSV'] ), 'fa:table green fa-lg' );
            ...
            $database->setChangeAction( new TAction( [$this, 'onDatabaseChange'] ) );
            $table->setChangeAction( new TAction( [$this, 'onTableChange'] ) );
