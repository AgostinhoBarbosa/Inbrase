<?php
    ...
    class TipoarquivoList extends TStandardList
    {
        ...
        public function __construct()
        {
            ...
            parent::setActiveRecord( 'Tipoarquivo' );
            ...
            $this->form->setFormTitle( 'Tipos de Arquivo' );
            ...
            $this->form->setData( TSession::getValue( 'Tipoarquivo_filter_data' ) );
            
            $this->form->addAction( _t( 'Find' ), new TAction( [ $this, 'onSearch' ] ), 'fa:search blue' );
            $this->form->addActionlink( _t( 'New' ), new TAction( [ 'TipoarquivoForm', 'onClear' ], [ 'register_state' => 'false' ] ), 'fa:eraser red' );
            
            $this->datagrid        = new BootstrapDatagridWrapper( new TQuickGrid );
            
            $column_id        = new TDataGridColumn( 'id', 'Código', 'center', '5%' );
            $column_nome      = new TDataGridColumn( 'nome', 'Descrição', 'left', '65%' );
            $column_liberacao = new TDataGridColumn( 'liberacao', 'Texto na Liberação', 'left', '30%' );
            
            $this->datagrid->addColumn( $column_id );
            $this->datagrid->addColumn( $column_nome );
            $this->datagrid->addColumn( $column_liberacao );
            ...
            $action_edit = new TDataGridAction( [ 'TipoarquivoForm', 'onEdit' ], [ 'key' => '{id}', 'register_state' => 'false' ] );
