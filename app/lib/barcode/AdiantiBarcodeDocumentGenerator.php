                ...
                if (!empty($barcode))
                {
                    ...
                    foreach (explode("\n", $label) as $label_line)
                    {
                        ...
                        if (trim($label_line) == '#barcode#')
                        {
                            ...
                            [$w,$h] = $this->Image($output, parent::GetX() + $this->imageMargin, parent::GetY(), $this->labelWidth -10 - $this->imageMargin, 0, '', '', true);
                        ...
                        else if (trim($label_line) == '#qrcode#')
                        {
                            ...
                            [$w,$h] = $this->Image($output, parent::GetX() + $this->imageMargin, parent::GetY(), 0, $this->barcodeHeight, '', '', true);
