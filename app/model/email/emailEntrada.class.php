<?php
    ...
    /**
     * Auto Arrematação Negativo Report
     *
    ...
    class emailEntrada
    {
        ...
        private $email_empresa = 'afincco@afincco.com.br';

        public function __construct( Processo $processo, $email_direto = TRUE )
        {
            $this->processoa        = $processo;
            $this->email_seguradora = '';
            if ( $email_direto ) {
                if ( $this->processoa->get_seguradoras()->enviar_email == 1 ) {
        ...
        public function gerarEmail()
        {
            try {
                ...
                $modelo = 'app/resources/email_entrada_geral.html';
                ...
                $assunto = "INFORMACAO DE LOCALIZACAO - ".$this->processoa->marca_modelo;
