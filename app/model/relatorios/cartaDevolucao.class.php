<?php
    ...
    class cartaDevolucao
    {
        private $processoa;
        private $arquivo;
        private $texto_motivo;


        public function __construct( Processo $processo, $motivo ) {
            $this->processoa = $processo;
            $this->texto_motivo = $motivo;
        ...
        function gerarTermo() {
            ...
            try {
                ...
                $texto = str_replace( '[TEXTO]', $this->texto_motivo, $texto );
                ...
                $arq_pdf = 'Carta_Devolucao_'.$this->processoa->id."_".rand().'.pdf';
                $arq     = 'tmp/'.$arq_pdf;

                $pdf = new mPDF();
                $pdf->SetTitle( "Carta Devolução Processo - ".$this->processoa->id );
