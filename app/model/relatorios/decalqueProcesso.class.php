    ...
    class decalqueProcesso
    {
        ...
        function gerarTermo() {
            ...
            try {
                ...
                $texto = str_replace( '[USUARIO]', TSession::getValue( 'username' ), $texto );
                ...
                $arq_pdf = 'laudo_Processo_'.$this->processoa->id."_".rand().'.pdf';
                $arq     = 'tmp/'.$arq_pdf;

                $pdf = new mPDF( '', 'A4', 0, '', 15, 15, 6, 6, 2, 9, 'P' );
                $pdf->SetTitle( "Laudo Processo - ".$this->processoa->id );
